                ...
                <div class="form">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td>Start After </td>
                                    <?php $task_order = $this->db->select("id,subject")->get_where('translation_request',array('id'=>$task->start_after_id))->row();?>
                                    <td colspan="3"><?=$task_order->id." - ".$task_order->subject?></td>
                                </tr> 
                        </tbody>
                    </table>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form class="cmxform form-horizontal " action="<?php echo base_url()?>projects/reopenTrasnlationTask" method="post" enctype="multipart/form-data">
