            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-center" id="exampleModalLabel" style="width: 100%;font-weight: bold;">Add Evaluation</h4>
                    ...
                    <form class="cmxform form-horizontal " action="<?= base_url() ?>projectManagment/doAddVendorEvaluation" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="setAction" id="setAction" value="1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <div class="emoji-container text-center">
                                        ...
                                        <input type="range" name="pm_ev_select" id="myRange" min="1" max="2" step="1" value="2" class="slider" onchange="getBadReviewDiv();">
                                    </div>
    ...
    ?>
        ...
        <div class="modal fade" id="evEditModal_<?= $row->id ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-center" id="exampleModalLabel" style="width: 100%;font-weight: bold;">Update Evaluation</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
                    <form class="cmxform form-horizontal " action="<?= base_url() ?>projectManagment/doAddVendorEvaluation" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="setAction" id="setAction" value="2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="emoji-container text-center">
                                            ...
                                            <p class="emoji-text" id="emoji-text">Satisfied</p>
                                            <input type="range" name="pm_ev_select" id="myRange" min="1" max="2" step="1" class="slider" onchange="getBadReviewDiv();" value="<?= $task_ev->pm_ev_select ?>">
                                        </div>
    ...
    ?>
        ...
        <div class="modal fade" id="evModal_<?= $row->id ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-center" id="exampleModalLabel" style="width: 100%;font-weight: bold;">Vendor Evaluation</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
...
<?php if ($pm_setup != false) { ?>
    ...
    <div id="pm_setup_edit" style="display:none">
        <table style="width: 100%">
            <thead>
                <tr>
                    <th width='5%'></th>
            ...
            <tbody>
                <?php for ($x = 1; $x <= 6; $x++) {
                    ...
                    if ($task_ev->$pm_ev_text != null && $task_ev->$pm_ev_text != '') {
                ?>
                        <tr>
                            <td>
