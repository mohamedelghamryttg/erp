    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>projects/doSaveProject" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12" id="LeadData">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="reject_reason" id="reject_reason" class="form-control" value="" rows="6"><?=$row->reject_reason?></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    <input class="btn btn-primary" type="submit" onclick="return checkCommentSave();" name="submit" value="Save">
                                  	<input class="btn btn-danger" type="submit" name="reject" onclick="return checkCommentReject();" value="Reject Project">
