		...
		<div class="row gutter-b">
			...
			<div class="col-6">
				<a href="<?= base_url() ?>hr/remoteAccess" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5 d-flex flex-grow-1 rounded flex-column align-items-center">
					...
					<span class="d-block font-weight-bold font-size-h6 mt-2">Remote <br>Access</span>
				</a>
			</div>
			<!--end::Item-->
			<!--begin::Item-->
			<div class="col-6">
				<a href="<?= base_url() ?>automation/addTicket" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5  d-flex flex-grow-1 rounded flex-column align-items-center">
					...
					<span class="d-block font-weight-bold font-size-h6 mt-2">Automation<br> Tickets</span>
				</a>
			</div>
			<!--end::Item-->
		</div>
		<div class="row gutter-b">
			...
			<div class="col-6">
				<a href="<?= base_url() ?>admin/whos" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5  d-flex flex-grow-1 rounded flex-column align-items-center">
					...
					<span class="d-block font-weight-bold font-size-h6 mt-2">Company<br> Directory</span>
				</a>
			</div>
			<!--end::Item-->
			<!--begin::Item-->
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			...
			<div class="d-flex flex-column">
				...
				<a href="<?php echo base_url(); ?>admin/profile" style="word-wrap: break-word;max-width: 95%;" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $this->session->userdata('username') ?></a>
				<div class="text-muted mt-1" style="word-wrap: break-word;max-width: 75%;">
					<?= $this->hr_model->getTitle($fUserData->title); ?>
				</div>
				<div class="navi mt-2">
					<a href="#" class="navi-item">
						<span class="navi-link p-0 pb-2">
							...
							<span class="navi-text text-muted text-hover-primary" style="word-break: break-word;max-width: 75%;font-size: 10px"><?= $this->admin_model->getUserEmail($this->session->userdata('id')) ?></span>
						</span>
					</a>
		...
		<div class="navi navi-spacer-x-0 p-0">
			<!--begin::Item-->
			<a href="<?php echo base_url(); ?>admin/profile"" class=" navi-item">
				<div class="navi-link">
		...
		<!--end::Separator-->
		<?php $menuMasterAccounts = $this->admin_model->getMasterUserBrands($this->session->userdata('master_user'));
		if (count($menuMasterAccounts) > 1) { ?>
			<!--begin::Notifications-->
			<div class="min-h-400px">
				<h5 class="mt-5">Your Accounts</h5>
				<div class="navi navi-spacer-x-0 p-0">
					<?php foreach ($menuMasterAccounts as $menuAccount) { ?>
						<!--begin::Item-->
						<a href="javascript:void(0);" class="navi-item border-2" style="<?= $menuAccount->id == $this->session->userdata('id') ? 'pointer-events: none; cursor: default;' : '' ?>" onclick="switchBrand('<?= $menuAccount->brand ?>','<?= $menuAccount->email ?>')">
							<div class="navi-link">
								<div class="symbol symbol-60 bg-white mr-3">
									<div class="symbol-label bg-white">
										<span class="svg-icon svg-icon-md svg-icon-success">
											<!--begin::Svg Icon | path:assets/media/svg/icons/General/Notification2.svg-->
											<img alt="Logo" src="<?php echo base_url(); ?>assets/images/<?= $this->admin_model->getBrandImage($menuAccount->brand) ?>" class="logo-default max-w-60px overflow-hidden" />
											<!--end::Svg Icon-->
										</span>
									</div>
								</div>
						...
						<div class="separator separator-dashed w-100 separator-primary mb-2"></div>
						<!--end:Item-->
					<?php } ?>
				</div>
			</div>
