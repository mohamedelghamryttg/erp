            ...
            if(type == 1 || type == 4){
                $("#typeData").html(`
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="date_sheet form-control" name="issue_date" id="payment_date" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Po Number</label>
                                        
                        <div class="col-lg-6 "><span id="number_list"></span>
                            <input type="text" class="form-control po_number" id='po_number' name="po_number[]" required="">
                        </div>
                        <div class="col-lg-3">
                            <a class="btn btn-dark text-white" onclick="getClientInvoicedPOsSingleChooseByNumber();"><i class='fa fa-search'></i> Search</a>
                        </div>
                    </div>
                ...
                $("#typeData").html(`
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 "><input type="hidden" class="form-control" id='number_list' readonly >
                            <input type="text" class="form-control po_number" id='po_number' name="po_number[]" required="">
                        </div>
                        <div class="col-lg-3">
                            <a class="btn btn-dark text-white" onclick="getClientInvoicedPOsMultipleChooseByNumber();"><i class='fa fa-search'></i> Search</a>
                        </div>
                    </div>
					<div class="form-group">
