        ...
        <form class="form" id="form" enctype="multipart/form-data">
            ...
            <div class="card text-center">
                <div class="card-header">
                    <h3>Bank Receipt Add Bank In</h3>
                </div>
            </div>
            <!--begin::Form-->
            ...
            <div class="card-body py-0 shadow-lg p-3 mb-5 bg-white rounded">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                        <div id="target" style="position:relative" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" id="cdate" name="cdate" data-toggle="datetimepicker" data-target="#Datetimepicker" autocomplete="off" style="width: 200px;" required>
                        </div>
                    </div>
                    <!-- </div>
                <div class="form-group row"> -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control" name="amount" id="amount" required step="any" placeholder="0.00" pattern="^\d*(\.\d{0,2})?$" onkeypress='return (event.charCode == 46 || event.charCode >= 48 && event.charCode <= 57)' required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control datetimepicker-input" id="cdate1" name="cdate1" data-toggle="datetimepicker" data-target="#Datetimepicker" autocomplete="off" required>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#form").submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= base_url() . "account/doAddbankinTrn" ?>",
                type: "POST",
                ...
                success: function(data) {
                    ...
                    if (data.records == 1)
                        alert("Bank In Receipt Already Exists!");
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data != '') {
                            ...
                            $('#bank_acc').val(data.cash_acc_acode)
                            $('#bank_acc_id').val(data.cash_acc_id)
                            $("#bank_acc_name").val(data.cash_acc_name);
                            if (data.rate === 0) {
