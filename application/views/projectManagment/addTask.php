    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>ProjectManagment/doAddTask" method="post" onsubmit="return addTaskForm();disableAddButton();" enctype="multipart/form-data">
                            ...
                            <div id="sendToAllVendors" style="display: none;">
                                ...
                                <div class="col-lg-6">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="col-lg-6" >
                                       <input type="text" name="rate" value=""  class="form-control m-b">
                                   </div>
                                </div>
                                 <div class="form-group">
