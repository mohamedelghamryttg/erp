...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title><?php $this->admin_model->getBrand($this->brand) ?> | Customer Experience</title>
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container">
                        ...
                        <div class="card card-custom example example-compact" style="box-shadow: -2px -2px 3px 4px rgba(20,20,20,0.4);width: 50%;margin-right: auto;margin-left: auto;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <!-- <div class="slidecontainer">
                                                    <input type="range" name="ev_select" min="0" max="10" value="5" step="5" class="slider" id="myRange" onchange="getBadReviewDiv();" oninput="this.nextElementSibling.value = this.value" style="display: inline-block;width: auto;"><output style="display: inline-block;position: relative;top: -25px;left: -11%;">5</output>
                                                </div> -->

                                                <div class="emoji-container text-center">
                                                    <div class="emoji" id="emoji" style="margin-left: auto;margin-right: auto;">
                                                    </div>
                                                    <p class="emoji-text" id="emoji-text">Satisfied</p>
                                                    <input type="range" name="ev_select" id="myRange" min="0" max="2" step="1" value="1" class="slider" onchange="getBadReviewDiv();">
                                                </div>
                    ...
                    <?php if ($customerEv == 0) { ?>
                        <div id="setup" style="display:none">
                            <table class="table table-head-custom table-checkable table-hover center" style="margin-left: auto;margin-right: auto;width: 50%;">
                                <thead>
                                    <tr>
                                        <th width='10%'></th>
                                        <th style="color:  darkred !important;">Items to be checked</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php for ($x = 1; $x <= 6; $x++) {
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td width='50' style="border: none;"><?= $evaluation->$c_ev_name ?></td>
                                            </tr>
                                    <?php }
                                    } ?>
                                </tbody>
...
<script>
    ...
    function getBadReviewDiv() {
        ...
        document.getElementById("emoji").innerHTML = emojis[index].emoji;
        document.getElementById("emoji-text").innerHTML = emojis[index].text;
