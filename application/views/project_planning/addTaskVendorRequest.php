    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                Send Vendor "Heads Up"
            </header>
            
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>projectPlanning/doAddVendorRequest" method="post" onsubmit="return addTaskForm();disableAddButton();" enctype="multipart/form-data">
