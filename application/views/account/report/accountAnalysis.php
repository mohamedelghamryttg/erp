<script type="text/javascript" src="<?php echo base_url(); ?>assets_new/js/jquery.table2excel.js"></script>
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"> -->
<!-- </script> -->
<!-- <script type="text/javascript" src="<?php echo base_url(); ?>assets_new/js/table2excel.js"></script> -->
    ...
    <div class="d-flex flex-column">
        ...
        <div class="d-flex flex-column">
            ...
            <div class="card card-custom gutter-b example example-compact"
                ...
                <div class="card-title" style="margin-bottom: auto;">
                    ...
                    <h3 class="card-title">General Ledger Account Analysis</h3>
                </div>
                ...
                <div class="card-body" style="padding-bottom :0;">
                    ...
                    <div class="card-footer" style="padding: 12px 0;">
                        <div class=" row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4">
                                <a class="btn btn-secondary btn-block exportToExcel" name="exportToExcelbtn"
                                    id="exportToExcelbtn" type="text">
                                    Export To
                                    Excel</a>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="card-body" style="padding-top :0;">
                ...
                <table id="kt_datatable_both_scrolls" class="table table-striped table-bordered gy-5 gs-7 table2excel">
                    <thead>
                        class="text-center">
...
<script>
    ...
    $("#exportToExcelbtn").click(function (e) {
        var table2excel = new Table2Excel({
            defaultFileName: "Account Analysis",
            preserveColors: File,
        });
        table2excel.export(document.querySelectorAll("table.table", "Account Analysis"));
        // $(".table").table2excel({
    ...
    $(document).ready(function () {
        ...
        $('#run').on('click', function (e) {
            ...
            if (vv_account) {
                $.ajax({
                    url: "<?= base_url() . "accountReport/accountAnalysis_calc" ?>",
                    type: "POST",
                    async: true,
                    dataType: 'json',
                    data: $('#form').serialize(),
        ...
        //     $("#kt_datatable_both_scrolls").table2excel({
        //         exclude: ".noExl",
        //         name: "Results"
        //     });
        // }
    ...
    function biuld_rep(data) {
        ...
        $.each(data.trns_ledger, function (index, value) {
            ...
            if (value.acc == '0') {
                ...
                s_balance = parseFloat(value.balance);

                if (parseFloat(s_balance) > 0) {
                    tot_d_balance += parseFloat(s_balance);
                } else {
                    tot_c_balance += Math.abs(parseFloat(s_balance));
                }
            ...
            html += '        <td class="text-nowrap" style="text-align: right;">' + (Number(value.balance) > 0 ? parseFloat(Math.abs(value.balance)).toFixed(2) : '') + '</td>';
            html += '        <td class="text-nowrap" style="text-align: right;">' + (Number(value.balance) < 0 ? parseFloat(Math.abs(value.balance)).toFixed(2) : '') + '</td>';
            html += '</tr>';
        ...
        balance = tot_d_balance - tot_c_balance;
        html += '       <tr>';
