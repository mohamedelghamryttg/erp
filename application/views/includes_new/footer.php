	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			...
			<div class="d-flex flex-column">
				...
				<a href="<?php echo base_url(); ?>admin/profile" style="word-wrap: break-word;max-width: 95%;"
					class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $this->session->userdata('username') ?></a>
					...
					<a href="#" class="navi-item">
						<span class="navi-link p-0 pb-2">
							...
							<span class="navi-text text-muted text-hover-primary"
								style="word-break: break-word;max-width: 75%;font-size: 10px"><?= $this->admin_model->getUserEmail($this->session->userdata('id')) ?></span>
						</span>
					</a>
			...
			<div class="min-h-400px">
				...
				<div class="navi navi-spacer-x-0 p-0">
					<?php foreach ($menuMasterAccounts as $menuAccount) { ?>
						<!--begin::Item-->
						<a href="javascript:void(0);" class="navi-item border-2"
							style="<?= $menuAccount->id == $this->session->userdata('id') ? 'pointer-events: none; cursor: default;' : '' ?>"
							onclick="switchBrand('<?= $menuAccount->brand ?>','<?= $menuAccount->email ?>')">
							<div class="navi-link">
								<div class="symbol symbol-60 bg-white mr-3">
									<div class="symbol-label bg-white">
										<span class="svg-icon svg-icon-md svg-icon-success">
											<!--begin::Svg Icon | path:assets/media/svg/icons/General/Notification2.svg-->
											<img alt="Logo"
												src="<?php echo base_url(); ?>assets/images/<?= $this->admin_model->getBrandImage($menuAccount->brand) ?>"
												class="logo-default max-w-60px overflow-hidden" />
											<!--end::Svg Icon-->
										</span>
									</div>
								</div>
								<div class="navi-text <?= $menuAccount->id == $this->session->userdata('id') ? 'text-danger' : '' ?>"
									...
									<div class="font-weight-bold">
										...
										<?php if ($menuAccount->id == $this->session->userdata('id')) { ?> <span
											class="font-weight-bold"><i class="fa fa-check-circle text-danger"></i></span>
									<?php } ?>
									</div>
...
<script type="text/javascript"
	src="<?php echo base_url(); ?>assets/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script type="text/javascript">
	// $("#filter").hide();
...
<script type="text/javascript">
	$(function () {
		$('.date_sheet').datepicker({ format: 'yyyy-mm-dd' });
	});
</script>
