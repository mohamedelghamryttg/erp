    ...
    <div class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <div class="card-body py-0 px-0">
                ...
                <table id="kt_datatable_both_scrolls" class="table table-striped row-bordered display nowrap table-hover table-responsive gy-5 gs-7">
                    <thead>
...
<script>
    ...
    function biuld_rep(data) {
        ...
        $.each(data.trns_ledger, function(index, value) {
            ...
            // html += '<td ></td>';
            //if (value.data1 != null) {
            html += '<td class="text-nowrap">' + (value.data2 ? value.data2 : '') + '</td>';
            // } else { html += '<td ></td>'; }
