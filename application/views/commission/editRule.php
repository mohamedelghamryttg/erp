<div class="d-flex flex-column-fluid mt-2">
    ...
    <div class="container">
        ...
        <div class="card card-custom example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" action="<?php echo base_url() ?>commission/doEditRule" onsubmit="return disableAddButton();" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right">Standalone % <span class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="number" name="standalone_per" class="form-control" required min="0" step=".05" value="<?= $row->standalone_per ?>" />
                        </div>
                        <label class="col-lg-2 col-form-label text-right">Team Leader %<span class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="number" name="teamleader_per" class="form-control" required min="0" step=".05" value="<?= $row->teamleader_per ?>" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right">Cost From Profit % <span class="text-danger">*</span></label>
                        <div class="col-lg-4">
                    ...
                    <table class="table text-center">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">If Cost From Profit < ..%</th>
                                <th scope="col">If Cost From Profit > ..%</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <a class="btn btn-secondary" href="<?php echo base_url() ?>commission" class="btn btn-default" type="button">Cancel</a>
                        </div>
                    </div>
                </div>
            </form>
