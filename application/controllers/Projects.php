...
class Projects extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($check) {
            ...
            $data['permission'] = $this->admin_model->getScreenByPermissionByRole($this->role, 37);
            //body ..
            $data['user'] = $this->user;
            ...
            $this->load->view('projects_new/view_projects.php');
    ...
    public function updateJobsPo()
    {
        $project = $this->db->get_where('project', array('status' => 1))->result();
        foreach ($project as $project) {
            $data['number'] = $project->po;
            $data['customer'] = $project->customer;
            $data['lead'] = $project->lead;
            $data['cpo_file'] = $project->cpo_file;
            $data['verified'] = $project->verified;
            $data['has_error'] = $project->has_error;
            $data['verified_by'] = $project->verified_by;
            $data['verified_at'] = $project->verified_at;
            $data['created_by'] = $project->closed_by;
            $data['created_at'] = $project->closed_date;

            if ($this->db->insert('po', $data)) {
                $jobData['po'] = $this->db->insert_id();
                $this->db->update('job', $jobData, array('project_id' => $project->id));
            } else {
                echo "not Inserted";
                echo "</br>";
            }
    ...
    public function addProject()
    {
        ...
        if ($check) {
            ...
            //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/addProject.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function doAddProject()
    {
        ...
        if ($check) {
            ...
            if ($this->db->insert('project', $data)) {
                ...
                $true = "Project Added Successfully ...";
                $this->session->set_flashdata('true', $true);
                redirect(base_url() . "projects/projectJobs?t=" . base64_encode($project_id));
            } else {
                $error = "Failed To Add Project ...";
                $this->session->set_flashdata('error', $error);
                redirect(base_url() . "projects");
    ...
    public function editProject()
    {
        ...
        if ($check) {
            ...
            //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/editProject.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    {
        // Check Permission ..
        $permission = $this->admin_model->getScreenByPermissionByRole($this->role, 37);
    ...
    public function projectJobs()
    {
        ...
        if ($check) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/projectJobs.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function addJob()
    {
        ...
        if ($check) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/addJob.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function editJob()
    {
        ...
        if ($check) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/editJob.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function deleteJob()
    {
        ...
        if ($permission->delete == 1) {
            ...
            if ($this->db->delete('job', array('id' => $id))) {
                ...
                $this->session->set_flashdata('true', $true);
                redirect(base_url() . "projects/projectJobs?t=" . base64_encode($project));
            } else {
    ...
    public function jobTasks()
    {
        ...
        if ($check) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/jobTasks.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function addTask()
    {
        ...
        if ($check) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/addTask.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function editTask()
    {
        ...
        if ($check) {
            //header ..
            redirect("projectManagment/editTask?t=" . $_GET['t'] . "&j=" . $_GET['j']);
            $data['group'] = $this->admin_model->getGroupByRole($this->role);
            $data['permission'] = $this->admin_model->getScreenByPermissionByRole($this->role, 70);
            //body ..
            $data['brand'] = $this->brand;
    ...
    public function deleteTask()
    {
        ...
        if ($permission->delete == 1) {
            ...
            if ($this->db->delete('job_task', array('id' => $id))) {
                ...
                $this->session->set_flashdata('true', $true);
                redirect(base_url() . "projects/jobTasks?t=" . base64_encode($job));
            } else {
    ...
    public function resendVpo()
    {
        $id = base64_decode($_GET['t']);
        $data['closed_by'] = $this->user;
        $this->projects_model->sendVPOMail($id, $this->user, $this->brand);
        $true = "VPO Sent Successfully ...";
        $this->session->set_flashdata('true', $true);
    ...
    // }
    // }else{
    // $error = "Please Close All Job Tasks First ...";
    // $this->session->set_flashdata('error', $error);
    // redirect(base_url()."projects/jobTasks?t=".$_POST['id']);   
    // }
    // }
    ...
    public function clientAllJobs()
    {
        ...
        if ($check) {
            ...
            if (isset($_POST['search'])) {
                ...
                $config['full_tag_open'] = "<ul class='pagination'>";
                $config['full_tag_close'] = "</ul>";
                $config['num_tag_open'] = '<li class="mr-3">';
                $config['num_tag_close'] = '</li>';
                $config['cur_tag_open'] = "<li class='active mr-3'><a href='#'>";
                $config['cur_tag_close'] = "<span class='sr-only'(current)></span></a></li>";
                $config['next_tag_open'] = "<li><span aria-hidden='true'>";
                $config['next_tagl_close'] = "</span></li>";
                $config['prev_tag_open'] = "<li><span aria-hidden='true'>";
    ...
    public function dtpRequest()
    {
        ...
        if ($check) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/dtpRequest.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function translationTask()
    {
        ...
        if ($data['permission']->add == 1) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/translationTask.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function addTranslationTask()
    {
        ...
        if ($data['permission']->add == 1) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/addTranslationTask.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function editTranslationTask()
    {
        ...
        if ($data['permission']->edit == 1) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/editTranslationTask.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function addLeTask()
    {
        ...
        if ($data['permission']->add == 1) {
            ...
            // //Pages ..
            $this->load->view('includes/header.php', $data);
            $this->load->view('projects/addLeTask.php');
            $this->load->view('includes/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function exportPmoReport()
    {
        ...
        header("Expires: 0");
        $data['permission'] = $this->admin_model->getScreenByPermissionByRole($this->role, 153);
        $this->load->view('projects/exportPmoReport.php', $data);
    }
    ...
    public function viewTask()
    {
        ...
        if ($check) {
            ...
            // //Pages ..
            $this->load->view('includes_new/header.php', $data);
            $this->load->view('projects_new/viewTask.php');
            $this->load->view('includes_new/footer.php');
        } else {
            echo "You have no permission to access this page";
        }
    ...
    public function pmConfirm()
    {
        ...
        if ($response == 0) {
            ...
            redirect("projects/reopenTask?t=" . base64_encode($task) . "&p=$job_status");
        } else {
            // status delivered
            $data['status'] = 1;
            $data['closed_date'] = date("Y-m-d H:i:s");
    ...
    public function confirmTasks()
    {
        ...
        if (isset($_POST['select'])) {
            ...
            $error = "There's Something Wrong , Please select at least one task!!";
        }
        if (strlen($error) > 0)
            $this->session->set_flashdata('error', $error);
        else
