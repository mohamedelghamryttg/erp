<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        ...
        <div class="card card-custom example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" action="<?php echo base_url() ?>dtp/doEditJob" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <input type="text" name="id" value="<?= base64_encode($job->id) ?>" hidden="">
                    <input type="text" name="request_id" value="<?= base64_encode($task->id) ?>" hidden=""> <!--begin::Card-->
                    <div class="card">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="insrtuctions" class="form-control ckeditor" rows="6"><?= $job->insrtuctions ?></textarea>
                        </div>
                    </div>
