						...
						<div class="card-body p-0 d-flex">
							<div
								...
								<div class="position-absolute right-0 bottom-0 overflow-hidden">
									<img src="<?= base_url() ?>assets_new/media/svg/humans/4963913.png"
										class="max-h-175px max-h-xl-325px mb-n5 mb-xl-n20" alt="" />
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body p-0">
							...
							<ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row"
								...
								<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
									<a href="<?= base_url() ?>hr/remoteAccess"
										class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center">
										<span class="nav-icon py-2 w-auto">
											<span
												class="svg-icon svg-icon-primary svg-icon-3x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo5\dist/../src/media/svg/icons\Navigation\Sign-in.svg--><svg
								...
								<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
									<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
										href="<?= base_url() ?>automation/tickets">
										<span class="nav-icon py-2 w-auto">
										...
										<span
											class="nav-text font-size-lg py-2 font-weight-bolder text-center">Automation
											Tickets</span>
									</a>
								</li>
								<!--end::Item-->
			...
			<div class="row">
				<div class="col-xl-12">
					<?php if ($this->role == 21 || $this->role == 1) { ?>
						<a href="<?php echo base_url() ?>server/singleOperationalReportBYBrand"
							class="btn btn-primary font-weight-bolder"
							onclick="return confirm('Sending Reports .... Are You Sure?')">
