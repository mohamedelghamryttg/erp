    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>ProjectPlanning/doAddLeTask" onsubmit="return disableAddButton();" method="post" enctype="multipart/form-data">
