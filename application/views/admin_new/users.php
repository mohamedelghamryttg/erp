              ...
              if($users->num_rows()>0)
              {
                foreach($users->result() as $row)
                {
                  ...
                  <tr class="">
                    ...
                    <td><?php echo $row->abbreviations;?></td>
                    <td><?php if($row->status == 1){echo "Active";}elseif($row->status == 0){echo "Deactive";}?></td>
                    <td>
                      <?php if($permission->edit == 1){ ?>
                      <a href="<?php echo base_url()?>admin/edituser?t=<?php echo base64_encode($row->id) ;?>" class="">
                    ...
                    <td>
                      ...
                      <a href="<?php echo base_url()?>admin/deleteUser/<?php echo $row->id ?>" title="delete" 
