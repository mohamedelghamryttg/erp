   ...
   <div class="container">
      <!--begin::Card-->
		<div class="card card-custom example example-compact">
			...
			<!--begin::Form-->
			<form class="form" id="form"action="<?php echo base_url()?>hr/doEditQaVacationPlan" method="post" enctype="multipart/form-data">
				 <div class="card-body">
                     ...
                     <?php if(isset($_SERVER['HTTP_REFERER'])){ ?>
                            ...
                            <?php }else{ ?>
                            <input type="text" name="referer" value="<?=base_url()?>qaVacationPlan" hidden>
                    <?php } ?>
