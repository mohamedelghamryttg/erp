          ...
          <table class="table table-striped table-hover table-bordered" style="overflow:scroll;">
            ...
            ?>
            	<tr>
                	...
                	<td><?=$row->number?></td>
                	<td><?php if($row->type == 2 || $row->type == 3){ echo $this->accounting_model->getSelectedPOs($row->pos) ; } ?></td>
                	<td><?=$row->amount?></td>
					...
					<td>
						<?php if($permission->delete == 1 && $row->status == 0){ ?>
							<a href="<?php echo base_url()?>accounting/deleteCreditNote?t=<?php echo base64_encode($row->id) ;?>" title="delete" 
									class="" onclick="return confirm('Are you sure you want to delete this Credit Note ?');">
