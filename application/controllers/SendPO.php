...
class SendPO extends CI_Controller {
    ...
    public function index(){
        ...
        $mailTo = "ghadaashraf257@gmail.com";
     ...
     $this->email->from("nuray.kevin@columbuslang.com");
      $this->email->cc("mohamed.elshehaby@columbuslang.com");
...
/*
    ...
    public function testVendor(){
        ...
        'smtp_host' => 'email-smtp.us-west-2.amazonaws.com',
        'smtp_port' => 25,
        'smtp_user' => 'AKIAXQIKSTQDQVJCE4GR',
        'smtp_pass' => "BN4vLbfKcxf4AMr62fxRQXumWx9Jj+jAmzXy8XRL/Ae4",
        'charset'=>'utf-8',
         'validate'=>TRUE,
        'wordwrap'=> TRUE,
    ...
    public function sendVendorTaskMailVendorModule(){
        $id = '53912';
        $brand = 1;
        $user="1";
