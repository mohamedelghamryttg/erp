      ...
      <div class="card">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Rules</h3>
          </div>
          <div class="card-toolbar">
            <form class="form" id="role_form" action="<?php echo base_url() ?>admin/role" method="post"
        ...
        <div class="card-body">
          ...
          <table class="table table-separate table-head-custom table-checkable table-hover table2excel"
            id="kt_datatable2">
            <thead>
              <tr>
                <th>ID</th>
                  ...
                  <tr class="">
                    ...
                    <td>
                      <?php if ($permission->delete == 1) { ?>
                        <a href="<?php echo base_url() ?>admin/deleteRole/<?php echo $row->id ?>" title="delete" class=""
