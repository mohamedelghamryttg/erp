    ...
    <div class="container">
      ...
      <div class="card card-custom gutter-b example example-compact">
        <div class="card-header">
          <h3 class="card-title">VPO Filter</h3>
        </div>

        <form class="form" id="costOfSales" method="get" action="<?php echo base_url() ?>accounting/verifiedVpo"
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <label class="col-lg-2 col-form-label text-lg-right" for="role name">Vendor Name</label>
              <div class="col-lg-3">
          ...
          <tbody>
            <?php foreach ($task->result() as $row) {
              ...
              <tr>
                ...
                <td>
                  <?php if (strlen($row->file) > 1) { ?><a href="<?= base_url() ?>assets/uploads/taskFile/<?= $row->file ?>"
