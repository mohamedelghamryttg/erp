...
<?php if($this->projects_model->checkCloseLERequest($task->id) && $task->status != 3){ ?>
      <!--begin::Card-->
                <div class="card">
                  ...
                  <div class="card-body">
                    <!--begin::Form-->
            <form class="form" action="<?php echo base_url()?>le/closeLERequest" method="post" enctype="multipart/form-data">
              ...
              <?php foreach ($response as $response) { ?>
                ...
                <?php } ?>
                 ...
                 <?php if($task->status != 3){ ?>
                     ...
                     <!--begin::Form-->
                    <form class="form" id="commentForm" action="<?php echo base_url()?>le/requestRespone" method="post" enctype="multipart/form-data">
                          <input name="id" type="hidden" value="<?=base64_encode($task->id)?>" readonly="">
                        <div class="card-body">
                           <div class="form-group row">
                                  <label class="col-lg-3 col-form-label text-right" for="comment">Comment:</label>
