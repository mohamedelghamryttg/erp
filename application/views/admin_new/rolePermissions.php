                                        ...
                                        foreach ($screens->result() as $k => $row)
                                            if ($k < 100) { {
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <select name="follow_<?= $row->id ?>" class="form-control"
                                                                style="width: 100%;">
                                                                <?= $this->admin_model->selectFollowUp($val->follow ?? '') ?>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <select name="view_<?= $row->id ?>" class="form-control"
                                                                style="width: 100%;">
                                                                <option value="0">-- Select Can View --</option>
                                                                <option <?= (!empty($val) && $val->view == 2) ? 'selected' : '' ?>
                                                                    value="2">View only assigned</option>
                                                                <option <?= (!empty($val) && $val->view == 1) ? 'selected' : '' ?>
                                                                    value="1">View ALL</option>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <div class="checkbox-inline" style="display: inline-block!important"
                                                                title="Add">
                                                                <label class="checkbox checkbox-lg ">
                                                                    <input type="checkbox" name="add_<?= $row->id ?>"
                                                                        <?= (!empty($val) && $val->add == 1) ? 'checked' : '' ?>
                                                                        value="1" />
                                                        ...
                                                        <td>
                                                            <div class="checkbox-inline" style="display: inline-block!important"
                                                                title="Edit">
                                                                <label class="checkbox checkbox-lg">
                                                                    <input type="checkbox" name="edit_<?= $row->id ?>"
                                                                        <?= (!empty($val) && $val->edit == 1) ? 'checked' : '' ?>
                                                                        value="1" />
                                                                    <span style="border: 1px solid;"></span>
                                                                </label>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="checkbox-inline" style="display: inline-block!important"
                                                                title="Delete">
                                                                <label class="checkbox checkbox-lg">
                                                                    <input type="checkbox" name="delete_<?= $row->id ?>"
                                                                        <?= (!empty($val) && $val->delete == 1) ? 'checked' : '' ?>
                                                                        value="1" />
                                                                    <span style="border: 1px solid;"></span>
                                                                </label>
                                                            </div>
