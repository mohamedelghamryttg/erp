        ...
        if($check){
            ...
            if(isset($_GET['search'])){
                ...
                if(isset($_REQUEST['subject'])){
                    ...
                    if(!empty($subject)){ array_push($arr2,3); }
                }else{
                    $subject = "";
                }
                if(isset($_REQUEST['status'])){
                    $data['status'] = $status = $_REQUEST['status'];
                    if(!empty($status)){ array_push($arr2,4); }
                }else{
                    $data['status'] = $status = "";
                }
                // print_r($arr2);
        ...
        if($check){
            ...
            $data['newTasks'] = $this->projects_model->newTranslationTasks($this->brand);
                ...
                if(isset($_REQUEST['status'])){
                    ...
                    if(!empty($status)){ array_push($arr2,3); }
                }else{
                    $status = "";
                }
                // print_r($arr2);
    ...
    public function TranslationTasks(){
        ...
        if($check){
            ...
            //body ..
                ...
                $arr1 = array($cond1,$cond2);                $arr_1_cnt = count($arr2);
                $arr3 = array();
                for($i=0; $i<$arr_1_cnt; $i++ ){
                array_push($arr3,$arr1[$arr2[$i]]);
                }
            ...
            //body ..
                ...
                if(isset($_GET['search'])){
                    ...
                    if(isset($_REQUEST['translator'])){
                        ...
                        if(!empty($translator)){ array_push($arr2,2); }
                    }else{
                        $translator = "";
                    }
                    // print_r($arr2);
