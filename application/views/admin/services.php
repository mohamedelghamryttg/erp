				...
				<div class="adv-table editable-table ">
					<div class="clearfix">
						<div class="btn-group">
							...
							<a href="" class="toggle-vis" data-column="1">Services</a> -
							<a href="" class="toggle-vis" data-column="2">Abbreviations</a> -
									...
									<tr class="">
										...
										<td>
											<?php if ($permission->edit == 1) { ?>
												<a href="<?php echo base_url() ?>admin/editService?t=<?php echo base64_encode($row->id); ?>"
													class="">
										...
										<td>
											<?php if ($permission->delete == 1) { ?>
												<a href="<?php echo base_url() ?>admin/deleteService/<?php echo $row->id ?>"
													title="delete" class=""
