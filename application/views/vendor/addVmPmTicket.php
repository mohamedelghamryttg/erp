...
<!-- <script src="https://cdn.tiny.cloud/1/n9uca7iun8b4f4qccsnivwr74mxo5dz6r15k06t6k7t27rvt/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script> -->
    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url() ?>vendor/doAddVmPmTicket" onsubmit="return checkResouceNumber();disableAddButton();" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class=" form-control" value="<?php echo  $this->db->query("SELECT name FROM `project` WHERE `id` = '$id' ")->row()->name;  ?>" name="ticket_subject" readonly="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <select name="task_type" value="" class="form-control m-b" id="task_type" required />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input size="16" type="text" required="" value="<?= date("Y-m-d H:i:s") ?>" autocomplete="off" class="form_datetime form-control" name="start_date" id="start_date">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input size="16" type="text" required="" autocomplete="off" class="form_datetime form-control" name="delivery_date" id="delivery_date">
                            </div>
                        </div>
                        ...
                        <!--                          <div class="form-group">
                              ...
                              <div class="col-md-6">
                                  <input size="16" type="text"  autocomplete="off" class="form_datetime form-control" name="due_date" id="due_date">
                              </div>
                          </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="comment" class="form-control ckeditor" rows="6"></textarea>
                            </div>
                        </div>
