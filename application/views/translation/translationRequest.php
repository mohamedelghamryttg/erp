		...
		<section class="panel">
			...
			<header class="panel-heading">
				<button id="button_filter2" onclick="showAndHide('filter2','button_filter2');" style="padding-top:0pc; float: right;background-color: transparent;font-size: 15px;" class="btn btn-sm btn-light text-dark"><i class="fa fa-chevron-down"></i></button>
				 Translation Requests Waiting Confimation - <span class="numberCircle"><span><?=$newTasks->num_rows()?></span></span>
			</header>
	...
	<div class="col-sm-12">
		<section class="panel">
			...
			<div id="filter" class="panel-body">
			  <form class="cmxform form-horizontal " id="translationRequestForm" action="<?php echo base_url()?>translation/" method="get" enctype="multipart/form-data">
