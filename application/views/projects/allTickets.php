	...
	<div class="col-sm-12">
	 ...
	 <?php 
			...
			<div class="panel-body">
			 <form class="cmxform form-horizontal " action="<?php echo base_url()?>projects/allTickets" method="get" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-3 col-lg-6">
                      ...
                      <a href="<?=base_url()?>projects/allTickets" class="btn btn-warning">(x) Clear Filter</a>
                  </div>
              </div>   
              </form>
			</div>
...
<!--										<td><?php echo $row->due_date ;?></td>-->
										...
										<td><?php echo $this->vendor_model->ticketTime($row->id).' Hour/s';?></td>
