...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            ?>
            <form class="form" id="accountfilter" action="<?php echo base_url() ?>account/accountList" method="get" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-lg-right">Search Account Name</label>
                        <div class="col-lg-3">
                            <input class="form-control" type="text" name="account_name" value="<?= $account_name ?>" autocomplete="off">
                        </div>
                        <div class="col-lg-7 text-lg-right">
                            <button class="btn btn-primary" name="search" type="submit">Search</button>

                            <a href="<?= base_url() ?>account/accountList" class="btn btn-warning"><i class="la la-trash"></i>Clear
                                Filter</a>

                            <button class="btn btn-secondary" onclick="var e2 = document.getElementById('accountfilter'); e2.action='<?= base_url() ?>account/exportaccount'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i>
                                Export To
                                Excel</button>
    ...
    <div class="card">
        ...
        <form class="form" action="<?php echo base_url() ?>account/editaccount" method="post" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url() ?>account/accountDelete?t=<?php echo
                                                                                                base64_encode($row->id); ?>" title="delete" class="" onclick="return confirm('Are you sure you want to delete this Account ?');">
