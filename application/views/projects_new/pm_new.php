                            ...
                            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-center mr-1">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        <!--begin::Page Title-->
                                        <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Wizard 2</h2>
                                        <!--end::Page Title-->
                                        <!--begin::Breadcrumb-->
                                                    ...
                                                    <div class="wizard-step">
                                                        <div class="wizard-wrapper">
                                                            ...
                                                            <div class="wizard-label">
                                                                 <a href="<?php base_url()?>OrderNew"><h3 class="wizard-title">Order</h3></a>
<!--                                                                 <div class="wizard-desc">Setup Your Account Details</div>
 -->                                                            </div>
                                                    ...
                                                    <div class="wizard-step" data-wizard-type="done">
                                                        <div class="wizard-wrapper">
                                                            <div class="wizard-icon">
                                                                <span class="svg-icon svg-icon-2x">
                                                            ...
                                                            <div class="wizard-label">
                                                                <a href="<?php base_url()?>LanguageNew"> <h3 class="wizard-title">Language</h3></a>
<!--                                                                 <div class="wizard-desc">Choose Your Location Map</div>
 -->                                                            </div>
                                                    ...
                                                    <div class="wizard-step" data-wizard-clickable="true" data-wizard-state="done">
                                                        <div class="wizard-wrapper">
                                                            <div class="wizard-icon">
                                                                <span class="svg-icon svg-icon-2x">
                                                            ...
                                                            <div class="wizard-label">
                                                               <a href="<?php base_url()?>JobsNew"> <h3 class="wizard-title">Jobs</h3></a>
                                                    ...
                                                    <div class="wizard-step" data-wizard-type="done">
                                                        <div class="wizard-wrapper">
                                                            ...
                                                            <div class="wizard-label">
                                                              <a href="<?php base_url()?>ProcessNew">  <h3 class="wizard-title">Process</h3></a>
<!--                                                                 <div class="wizard-desc">Address, Street, City, State</div>
 -->                                                            </div>
                                                    ...
                                                    <div class="wizard-step" data-wizard-clickable="true" data-wizard-state="current">
                                                        <div class="wizard-wrapper">
                                                            <div class="wizard-icon">
                                                                <span class="svg-icon svg-icon-2x">
                                                            ...
                                                            <div class="wizard-label">
                                                               <a href="<?php base_url()?>FilesNew"> <h3 class="wizard-title">Files</h3></a>
<!--                                                                 <div class="wizard-desc">Use Credit or Debit Cards</div> -->
                                                    ...
                                                    <div class="wizard-step" data-wizard-type="done">
                                                        <div class="wizard-wrapper">
                                                            ...
                                                            <div class="wizard-label">
                                                                <a href="<?php base_url()?>FinanceNew"> <h3 class="wizard-title">Finance</h3></a>
<!--                                                                 <div class="wizard-desc">Review and Submit</div> -->
                                                    ...
                                                    <div class="wizard-step" data-wizard-type="done">
                                                        <div class="wizard-wrapper">
                                                            ...
                                                            <div class="wizard-label">
                                                                 <a href="<?php base_url()?>PeopleNew"> <h3 class="wizard-title">People</h3></a>
<!--                                                                 <div class="wizard-desc">Review and Submit</div> -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="wizard-step" data-wizard-type="done">
                                                        <div class="wizard-wrapper">
                                                            ...
                                                            <div class="wizard-label">
                                                                 <a href="<?php base_url()?>QualityNew"> <h3 class="wizard-title">Quality assurance</h3></a>
<!--                                                                 <div class="wizard-desc">Review and Submit</div> -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--end::Wizard Step 6 Nav-->
                                                       ...
                                                       <div class="wizard-step">
                                                        <div class="wizard-wrapper">
                                                            ...
                                                            <div class="wizard-label">
                                                                <a href="<?php base_url()?>/HistoryNew"><h3 class="wizard-title">History</h3></a>
<!--                                                                 <div class="wizard-desc">Review and Submit</div> -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="offset-xxl-2 col-xxl-8">
                                                        <form class="form" id="kt_form">
                                                            <!--begin: Wizard Step 1-->
                                                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="done">
