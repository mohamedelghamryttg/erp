        ...
        <form class="cmxform form-horizontal " id="form" method="post" enctype="multipart/form-data"
            ...
            <div class="card card-custom example example-compact"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <select name='bank_id' class='form-control m-b' id="bank_id" required>
                            ...
                            <?= $this->AccountModel->selectPaymentCombo('payment_method', $bankout->bank_id, $brand_id, '2'); ?>
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="date_sheet form-control" name="cdate" id="cdate"
                            value="<?= date("Y-m-d", strtotime($bankout->date)) ?>" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <select class="form-control" name="trn_id" id="trn_id" required>
                            ...
                            <?= $this->AccountModel->Allrevenue($brand_id, $bankout->trn_id, $acc_setup->bank_acc_id) ?>
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" class="form-control" name="amount" id="amount"
                            value="<?= $bankout->amount ?>" required step="any" placeholder="0.00"
                            pattern="^\d*(\.\d{0,2})?$"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control" name="check_no" id="check_no"
                            value="<?= $bankout->check_no ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" class="form-control" name="rate" id="rate" value="<?= $bankout->rate ?>"
            ...
            <table class="datatable-bordered datatable-head-custom datatable-table" id="kt_datatable"
                ...
                <thead class="datatable-head">
                    <tr class="datatable-row" style="left: 0px;">
                        <th data-field="debit" class="datatable-cell datatable-cell-sort"><span style="width: 112px;"
                                style="width: 112px;text-align: center;">Debit</span></th>
                        <th data-field="credit" class="datatable-cell datatable-cell-sort"><span style="width: 112px;"
                                style="width: 112px;text-align: center;">Credit</span></th>
                        <th data-field="acount" class="datatable-cell datatable-cell-sort"><span style="width: 112px;"
                                style="width: 112px;text-align: center;">Account</span></th>
                        <th data-field="revenue" class="datatable-cell datatable-cell-sort"><span style="width: 112px;"
                                style="width: 112px;text-align: center;">Account Type</span></th>
                        <th data-field="currency" class="datatable-cell datatable-cell-sort"><span style="width: 112px;"
                                style="width: 112px;text-align: center;">Currency</span></th>
                        <th data-field="rate" class="datatable-cell datatable-cell-sort"><span style="width: 112px;"
                                style="width: 112px;text-align: center;">Rate</span></th>
                        <th data-field="evamount" data-autohide-disabled="false"
                            class="datatable-cell datatable-cell-sort">
                            <span style="width: 112px;" style="width: 112px;text-align: center;">Ev. Amount</span>
                        </th>
                    </tr>
                </thead>
                <tbody class="datatable-body entry_table">
                    <tr data-row="0" class="datatable-row no-padding" id="row1" style="left: 0px;">
                    </tr>
                    <tr data-row="1" class="datatable-row" id="row2" style="left: 0px;">
                    </tr>
                </tbody>
            </table>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#submit").click(function (event) {
            $.ajax({
                url: "<?= base_url() . "account/doEditbankhoutTrn" ?>",
                type: "POST",
                data: $("#form").serialize(),
                beforeSend: function () {
