 ...
 <!-- start search form card --> 
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h4 class="card-title">Tickets Filter</h4>
                </div>
                <div class="card-body">
                    <form class="form" id="tickets" action="<?php echo current_url()?>" method="get" enctype="multipart/form-data">
                          
                        <div class="form-group row">  
                            <label class="col-lg-3 col-form-label text-lg-right">Created By:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <a href="<?=current_url()?>" class="btn btn-danger"><i class="la la-trash"></i>Clear Filter</a> 
            ...
            <div class="card">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h5 class="card-label">VM Tickets </h5>
                    </div>
                    <div class="card-toolbar">

                        <!--begin::Button-->
                        <?php if ($permission->add == 1) { ?>
                            <a href="<?= base_url() ?>vendor/addSalesVmTicketMultiLang" class="btn btn-primary font-weight-bolder"> 
                            <?php } ?>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-head-custom table-checkable table-hover" >
                        ...
                        <tbody>
                            ...
                            base64_encode($row->id);
                                        ?>&from=<?= base64_encode(0) ?>" class="" title="View Ticket">
