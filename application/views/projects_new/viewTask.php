                ...
                <div class="tab-content pt-5">
                    ...
                    <div class="tab-pane" id="kt_apps_projects_view_tab_4" role="tabpanel">
                        ...
                        <div class="form-group row">
                               ...
                               <div class="col-lg-6 pt-2">
                                   <?php if (strlen($row->vendor_attachment) > 1) { ?><a href="https://aixnexus.com/thetranslationgate.com/assets/uploads/jobTaskVendorFiles/<?= $row->vendor_attachment ?>" target="_blank">Click Here ..</a><?php } ?>

                               </div>
                       </div>
                      <?php if($row->status == 5){?>
                       <form class="form" action="<?php echo base_url()?>projects/pmConfirm" method="post" enctype="multipart/form-data">
