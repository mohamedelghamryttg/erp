  ...
  <?php if($this->session->flashdata('error')){ ?>
   ...
   <?php  } ?>
          ...
          <div class="card-header">
            <h3 class="card-title">Search Favourite Vendor</h3>
          </div>
         <?php 
         ...
         ?>
            <form class="cmxform form-horizontal " id="vendors" action="<?php echo base_url()?>vendor/favouriteVendor" method="get" enctype="multipart/form-data">
             <div class="card-body">
                ...
                <div class="card">
                  <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                      <h3 class="card-label">Favourite Vendors</h3>
                    </div>
                 ...
                 <tbody>
                      ...
                      ?>
                            <tr style="<?=$style?>" class="">
                              ...
                              <td> <a class="text-bold" href="<?php echo base_url()?>vendor/changeVendorFavourite?t=<?=base64_encode($row->id)?>&f=0"onclick="return confirm('Removing This Vendor From Favourite List, Are you sure ... ?');"  title="Vendor Marked As Favourite , Click To Remove From Favourite List ">
                                        <i class="flaticon-circle icon-lg text-danger"></i>
                                    </a></td>
