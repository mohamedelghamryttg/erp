	...
	<div class="d-flex flex-column-fluid">
		...
		<div class="container">
			...
			<div class="card card-custom gutter-b example example-compact">
				...
				?>
				<form class="form" action="<?php echo base_url() ?>hr/department" method="get" id="departments"
						...
						<div class="card-footer">
							<div class="row">
								...
								<div class="col-lg-10">
									...
									<a href="<?= base_url() ?>hr/department" class="btn btn-warning"><i
		...
		<div class="card">
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				<div class="card-title">
					<h3 class="card-label">Department </h3>
				</div>
				<div class="card-toolbar">

					<!--begin::Button-->
					<?php if ($permission->add == 1) { ?>
						<a href="<?= base_url() ?>hr/addDepartment" class="btn btn-primary font-weight-bolder">
						<?php } ?>
								...
								<tr class="">
									...
									<td>
										<?php if ($permission->edit == 1) { ?>
											<a href="<?php echo base_url() ?>hr/editDepartment?t=<?php echo base64_encode($row->id); ?>"
									...
									<td>
										<?php if ($permission->delete == 1) { ?>
											<a href="<?php echo base_url() ?>hr/deleteDepartment/<?php echo $row->id ?>"
