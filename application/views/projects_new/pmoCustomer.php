<!--begin::Content-->
          ...
          <div class="card-header">
            ...
            <form class="form" id="pmoCustomer" action="<?php echo base_url()?>projects/pmoCustomer" method="get" enctype="multipart/form-data">
             <div class="card-body">
               ...
               <label class="col-lg-2 control-label" for="role name">Date To</label>
                        <div class="col-lg-3">
                        <input class="form-control date_sheet" type="text" name="date_to" autocomplete="off" required value="<?=$date_from??''?>">
                        </div>
              </div>
               <div class="form-group row">
             ...
             <div class="card-footer">
              <div class="row">
               ...
               <div class="col-lg-10">
                           <button class="btn btn-success mr-2" name="search"  onclick="var e2 = document.getElementById('pmoCustomer'); e2.action='<?=base_url()?>projects/pmoCustomer'; e2.submit();" type="submit">Search</button>  
                           <button class="btn btn-secondary" onclick="var e2 = document.getElementById('pmoCustomer'); e2.action='<?=base_url()?>projects/exportPmoCustomer'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button>  
                         <a href="<?=base_url()?>projects/pmoCustomer" class="btn btn-warning"><i class="la la-trash"></i>Clear Filter</a> 
