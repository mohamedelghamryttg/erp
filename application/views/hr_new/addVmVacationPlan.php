   ...
   <div class="container">
      <!--begin::Card-->
		<div class="card card-custom example example-compact">
			...
			<!--begin::Form--> 
			<form class="form" action="<?php echo base_url()?>hr/doAddVmVacationPlan" method="post"onsubmit="" enctype="multipart/form-data">
				<div class="card-body">
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<a class="btn btn-secondary" href="<?php echo base_url()?>hr/vmVacationPlan" class="btn btn-default" type="button">Cancel</a>
						</div>
					</div>
				</div>
			</form>
