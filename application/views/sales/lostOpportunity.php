	...
	<div class="col-sm-12">
		<section class="panel">
			...
			<div class="panel-body">
			 <form class="cmxform form-horizontal " id="lostOpportunityForm" action="<?php echo base_url()?>sales/lostOpportunity" method="get" enctype="multipart/form-data">
			 	<?php  
              if(isset($_REQUEST['project_name'])){
				...
				<div class="form-group">
                    ...
                    <label class="col-lg-2 control-label" for="role Task Type">PM</label>
					<div class="col-lg-3">
				...
				<div class="adv-table editable-table " style="overflow:scroll;">
					<div class="clearfix">
						...
						<?php if($permission->add == 1){ ?>
							...
							<a  href="<?=base_url()?>sales/addLostOpportunity" class="btn btn-primary ">Add Lost Opportunity</a>
							</br></br></br>
						<?php } ?>
						</div>
						...
						<thead>
							<tr>
							  <tr>
								 ...
								 <th>Customer</th>
								 <th>Project Name</th>
								 <th>Product Line</th>								 <th>Lost Reasons</th>
                             	 <th>Service</th>
                             	 <th>Source</th>
                             	 <th>Target</th>
                             	 <th>Task Type</th>
