    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>le/doEditJob" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                      <input type="text" name="volume" class="form-control" value="<?= $job->volume ?>" rows="6"></input>
                                </div>
                            </div>
