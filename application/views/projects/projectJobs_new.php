        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="adv-table editable-table " style="overflow:scroll;">
                      ...
                      <td><?php echo $this->customer_model->getProductLine($project_data->product_line);?></td>
                        <?php if($this->brand == 1){?>  
                      <td><?=$this->projects_model->getTTGBranchName($project_data->branch_name)?></td>
                       <?php }?>
                      <td>
            ...
            <div class="panel-body">
                <div class="adv-table editable-table " style="overflow-y: scroll;">
                        ...
                        <form class="cmxform form-horizontal " action="<?php echo base_url()?>projects/closeJobNew" onsubmit="return checkJobVerifyForm();" method="post" enctype="multipart/form-data">
                         <input type="text" name="project_id" value="<?=base64_encode($project_data->id)?>" hidden="">
                         <div class="form-group">
                             <div class="col-lg-3 font-weight-bold font-size-h5">Close Jobs :</div>
                                    <div class="col-lg-6">
                                        <select name="po" class="form-control" required="">
                                            <?= $this->projects_model->selectPoAvailable($project_data->id);?>
                                        </select>
                                        <input type="submit" style="margin-right: 5rem;" name="save" value="Close Jobs" class="btn btn-primary">
