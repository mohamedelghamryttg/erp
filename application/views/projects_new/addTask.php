...
<div class="d-flex flex-column-fluid">
	...
	<div class="container">
		...
		<div class="card card-custom example example-compact">
			...
			<!--begin::Form-->
			<form class="form" action="<?php echo base_url() ?>projects/doAddTask"
				onsubmit="return addTaskForm();disableAddButton();" method="post" enctype="multipart/form-data">
				...
				<div class="card-body">
							...
							<table class="table table-striped table-hover table-bordered" id=""
								...
								<tbody>
									<tr class="">
										...
										<td><?= $this->sales_model->calculateRevenueJob($job_data->id, $job_data->type, $job_data->volume, $priceList->id) ?>
										</td>
										<td>
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<input type="text" class=" form-control" value="<?= $job_data->name ?>" name="subject"
								id="subject" required>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<select name="task_type" class="form-control m-b"
								onchange="getVendorByTask('<?= $priceList->service ?>','<?= $priceList->source ?>','<?= $priceList->target ?>');getVendorData('<?= $priceList->source ?>','<?= $priceList->target ?>')"
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<select name="vendor"
								onchange="getVendorData('<?= $priceList->source ?>','<?= $priceList->target ?>')"
								class="form-control m-b" id="vendor" required />
							<option disabled="disabled" selected=""></option>
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<input type="text" class=" form-control" onkeypress="return numbersOnly(event)"
								onblur="calculateVendorCostChecked()" name="count" id="count" required>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<input type="text" class=" form-control" readonly="readonly" name="total_cost"
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<input size="16" type="text" onchange="checkDate('start_date')"
								value="<?= date("Y-m-d H:i:s") ?>" autocomplete="off" class="form_datetime form-control"
				...
				<div class="card-footer">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<a class="btn btn-secondary" href="<?php echo base_url() ?>projects" class="btn btn-default"
