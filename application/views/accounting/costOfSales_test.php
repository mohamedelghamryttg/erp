  ...
  <div class="col-sm-12">
    <section class="panel">
      ...
      <div class="panel-body">
       <form class="cmxform form-horizontal " id="costOfSales" action="<?php echo base_url()?>accounting/costOfSales_test" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="col-lg-offset-3 col-lg-6">
                ...
                <button class="btn btn-success" onclick="var e2 = document.getElementById('costOfSales'); e2.action='<?=base_url()?>accounting/exportCostOfSales_test'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button>
            </div>
        </div> 
        </form>
      </div>
