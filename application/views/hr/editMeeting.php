    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>hr/doEditMeeting/<?=$meeting_room_schedule->id?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" value="<?=$meeting_room_schedule->title?>" class=" form-control" name="title" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6">
                                  <input size="16" type="text" onchange="checkDate('start_date')" autocomplete="off" class="form_datetime form-control" value="<?=$meeting_room_schedule->start?>" name="start_date" id="start_date" required="">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-6">
                                  <input size="16" type="text" onchange="checkDate('end_date')" autocomplete="off" class="form_datetime form-control" value="<?=$meeting_room_schedule->end?>" name="end_date" id="end_date" required="">
                              </div>
                          </div>
