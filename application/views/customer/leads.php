  ...
  <div class="col-sm-12">
    <section class="panel">
      ...
      <div class="panel-body">
       <form class="cmxform form-horizontal " action="<?php echo base_url()?>customer/leads" method="get" id="leads" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-3 col-lg-6">
                      <button class="btn btn-primary" name="search" onclick="var e2 = document.getElementById('leads'); e2.action='<?=base_url()?>customer/leads'; e2.submit();" type="submit">Search</button>
                      <button class="btn btn-success" onclick="var e2 = document.getElementById('leads'); e2.action='<?=base_url()?>customer/exportleads'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button> 
                      <a href="<?=base_url()?>customer/leads" class="btn btn-warning">(x) Clear Filter</a>
                  </div>
              </div>     
              </form>
      </div>
                ...
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <?php if($permission->add == 1){ ?>
                            <a href="<?=base_url()?>customer/addLead" class="btn btn-primary ">Add New</a>
                            </br></br></br>
                        <?php } ?>
                        Show / Hide:
                        ...
                        <a href="" class="toggle-vis" data-column="7">Status</a>  - 
                        <a href="" class="toggle-vis" data-column="8">Approved</a>  - 
                        <a href="" class="toggle-vis" data-column="9">Created By</a> -
                        <a href="" class="toggle-vis" data-column="10">Created At</a>  - 
                        <a href="" class="toggle-vis" data-column="11">Edit</a>  -
                        <a href="" class="toggle-vis" data-column="12">Delete</a>
                        </br></br></br>
                        </div>
