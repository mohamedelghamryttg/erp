            ...
            <tbody>
              ...
              ?>
                <tr class="">
                  ...
                  <td><?php if ($row->edit == 1) {
                        echo "Yes";
                      } else {
                        echo "No";
                      } ?></td>
                  <td><?php if ($row->delete == 1) {
                        echo "Yes";
                      } else {
                        echo "No";
                      } ?></td>
                  ...
                  <td>
                    <?php if ($permission->delete == 1) { ?>
                      <a href="<?php echo base_url() ?>admin/deletePermission/<?php echo $row->id ?>" title="delete" class="" onclick="return confirm('Are you sure you want to delete this Permission ?');">
