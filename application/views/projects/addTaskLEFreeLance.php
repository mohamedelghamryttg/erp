    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                Add New LE (Freelancer) Task
            </header>
            
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>projects/doAddTask" method="post" onsubmit="return addTaskForm();disableAddButton();" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <b>Localization Engineering</b>
                                    <input type="text" name="task_type" value="43" hidden="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <select name="vendor" onchange="getVendorDataLEFreelancer('<?=$priceList->source?>','<?=$priceList->target?>')" class="form-control m-b" id="vendor" required />
                                            <option disabled="disabled" selected=""></option>
                                            <?=$this->vendor_model->selectVendorByJobLEFreelancer(0,$brand)?>
                                    </select>
                                </div>
                            </div>
