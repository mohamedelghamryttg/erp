            ...
            <div class="card-toolbar">
                <?php if ($permission->add == 1) { ?>
                    <a href="<?= base_url() ?>commission/addPmRule" class="btn btn-dark btn-sm font-weight-bolder">
                        <i class="fa fa-pen"></i>Add New PM Rule</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($permission->edit == 1) { ?>
                                    <a href="<?= base_url() . 'commission/editPmRule?t=' . base64_encode($row->id); ?>" class="btn btn-sm btn-clean btn-icon mr-2">
                                ...
                                if ($permission->delete == 1) { ?>
                                    <a href="<?= base_url() . 'commission/deletePmRule?t=' . base64_encode($row->id); ?>" class="btn btn-sm btn-clean btn-icon mr-2" onclick="return confirm('Are you sure you want to delete this rule?');">
