			 ...
			 <form class="cmxform form-horizontal " id="dtpCOGS" method="get" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-3 col-lg-6">
                      <button class="btn btn-primary" name="search" onclick="var e2 = document.getElementById('dtpCOGS'); e2.action='<?=base_url()?>accounting/dtpRevenueReport'; e2.submit();" type="submit">Search</button>
