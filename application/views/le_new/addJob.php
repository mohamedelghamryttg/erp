   ...
   <div class="container">
      <!--begin::Card-->
		<div class="card card-custom example example-compact">
			...
			<!--begin::Form-->
			<form class="form"action="<?php echo base_url()?>le/doAddJob" onsubmit="return disableAddButton();" method="post" enctype="multipart/form-data">
				 <div class="card-body">
                ...
                <!--end::Card-->
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
          							  ...
          							  <div class="col-lg-6">
          							  	<input class="form-control"  name="volume" value="<?= $task->volume?>" id="volume" />
