...
<!--begin::Content-->
          ...
          <div class="card-header">
            <h3 class="card-title">Search Lost Opportunities</h3>
          </div>
          <?php  
        ...
        ?>
            ...
            <form class="form" id="lostOpportunityForm" action="<?php echo base_url()?>sales/lostOpportunity" method="get" enctype="multipart/form-data">
             <div class="card-body">
               ...
               <div class="col-lg-3">
                <input type="text" class="form-control" value="<?= $projectName?>" name="project_name">
               </div>  
              ...
              <div class="form-group row">
               ...
               <label class="col-lg-2 col-form-label text-lg-right">PM</label>
               <div class="col-lg-3">
              ...
              <div class="row">
               ...
               <div class="col-lg-10">
                     <button class="btn btn-primary" name="search" type="submit">Search</button> 
                      <button class="btn btn-success" onclick="var e2 = document.getElementById('lostOpportunityForm'); e2.action='<?=base_url()?>sales/exportlostOpportunity'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button> 
              <a href="<?=base_url()?>sales/lostOpportunity" class="btn btn-warning">(x) Clear Filter</a> 
                ...
                <div class="card">
                  <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                      <h3 class="card-label">Lost Opportunities</h3>
                    </div>
                    <div class="card-toolbar">
                     
                     <!--begin::Button-->
                      <?php if($permission->add == 1){ ?>
                        <a href="<?=base_url()?>sales/addLostOpportunity" class="btn btn-primary font-weight-bolder"> 
                      <?php } ?>
            ...
            ?>
                <tr class="">
                  ...
                  <td>
                      ...
                      <a href="<?php echo base_url()?>sales/editLostOpportunity?t=<?php echo 
                    ...
                    <td>
                      ...
                      <a href="<?php echo base_url()?>sales/deleteLostOpportunity?t=<?php echo 
