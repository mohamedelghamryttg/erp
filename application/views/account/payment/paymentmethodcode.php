    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form class="form" id="payment_method" action="<?php echo base_url() ?>account/paymentmethodcode" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <a href="<?= base_url() ?>account/paymentmethodcode" class="btn btn-warning"><i class="la la-trash"></i>Clear Filter</a>

                                    <button class="btn btn-secondary" onclick="var e2 = document.getElementById('payment_method'); e2.action='<?= base_url() ?>account/exportpaymentmethodcode'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i>
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <?php if ($permission->edit == 1) { ?>
                                                <a href="<?php echo base_url() ?>account/editpaymentmethodcode?t=<?php echo base64_encode($row->id); ?>" class="">
                                        ...
                                        <td>
                                            <?php if ($permission->delete == 1) { ?>
                                                <a href="<?php echo base_url() ?>account/deletepaymentmethodcode/<?php echo $row->id ?>" title="delete" class="" onclick="return confirm('Are you sure you want to delete this user?');">
