                ...
                <div class="card-body">
                    <table class="table table-head-custom table-hover" width="100%" id="kt_datatable2">
                        ...
                        <tbody>                            
                            ...
                            <tr>
                                <td width="40%"><p class="text-success font-weight-bolder">From</p></td>
                                <td width="60%"><?= $ticket->from_email ?></td>
                            </tr>
                            <tr>
                                <td width="40%"><p class="text-success font-weight-bolder">CC</p></td>
                                <td width="60%"><?= $ticket->cc_email ?></td>
                            </tr>
                            <tr>
                                <td width="40%"><p class="text-success font-weight-bolder">Subject</p></td>
                                <td width="60%"><?= $ticket->subject ?></td>
                            </tr>
                            <tr>
                                <td width="40%"><p class="text-success font-weight-bolder">Body</p></td>
                                <td width="60%"><?= $ticket->body ?></td>
                            </tr>                           
                            <tr>
