	...
	<div class="col-lg-12">
		<section class="panel">
			...
			<div class="panel-body">
				<div class="form">
					<form class="cmxform form-horizontal " id="commentForm" action="<?php echo base_url()?>customer/doAddCustomerPortal?t=<?=base64_encode($id)?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class=" form-control" name="portal" data-maxlength="300" id="portal" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-3 control-label" for="User Name">User Name</label>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a href="<?php echo base_url()?>customer/customerPortal?t=<?=base64_encode($id)?>" class="btn btn-default" type="button">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
