      ...
      <div class="card">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">
              <?php echo $this->customer_model->getCustomer($lead->customer); ?> -
              <?php echo $this->admin_model->getCountry($lead->country); ?> - Contacts
            </h3>
          </div>
          <div class="card-toolbar">
            ...
            <?php if ($permission->add == 1) { ?>
              <a href="<?= base_url() ?>customer/addLeadContacts?t=<?= base64_encode($id) ?>"
            ...
            <tbody>
              <?php foreach ($contacts->result() as $row) { ?>
                <tr class="">
                  ...
                  <td>
                    <?php echo $row->skype_account; ?>
                  </td>
                  <td>
                    <?php echo $this->admin_model->getAdmin($row->created_by); ?><br />
