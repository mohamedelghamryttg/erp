		            ...
		            <div class="col-lg-3">
						 ...
						 <div class="card-footer">
						  <div class="row">
						   ...
						   <div class="col-lg-10">
                           <button class="btn btn-success mr-2" name="search"  onclick="var e2 = document.getElementById('dtpCOGS'); e2.action='<?=base_url()?>report/dtpCOGS'; e2.submit();" type="submit">Search</button>	
                           <button class="btn btn-secondary" onclick="var e2 = document.getElementById('dtpCOGS'); e2.action='<?=base_url()?>report/exportDtpCOGS'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button>	
                    	   <a href="<?=base_url()?>report/dtpCOGS" class="btn btn-warning"><i class="la la-trash"></i>Clear Filter</a> 
