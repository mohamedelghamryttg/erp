      ...
      <div class="card card-custom gutter-b example example-compact">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title btn_lightgray">
            <h3 class="card-label">Your Projects From SAM - <span class="btn btn-danger"><span>
                  <?= $opportunity->num_rows() ?>
                </span></span></h3>
            <button id="button_filter2" onclick="showAndHide('filter2','button_filter2');"
              style="padding-top:0pc; float: right;font-size: 15px;" class="btn btn-success "><i
      ...
      <div class="card card-custom gutter-b example example-compact">
        ...
        <div class="card-body" id="filter">
          <div class="card card-custom gutter-b example example-compact">
            ...
            <form class="cmxform form-horizontal " action="<?php echo base_url() ?>ProjectManagment" method="get"
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($row->status == 0) { ?>
                      <a class="btn btn-primary"
                        href="<?php echo base_url() ?>vendor/vmPmTicket?t=<?php echo base64_encode($row->id); ?>"
                        title="View Tickets" style="color:#fff">View Tickets</a>
                    <?php } ?>
                  </td>
                  <td>
                  ...
                  <td>
                    <?php if ($permission->edit == 1 && $row->status == 0) { ?>
                      <a href="<?php echo base_url() ?>projectManagment/editProject?t=<?php echo
                           base64_encode($row->id); ?>" class="">
                  ...
                  <td>
                    <?php if ($permission->delete == 1 && $row->status == 0) { ?>
                      <a href="<?php echo base_url() ?>projectManagment/deleteProject?t=<?php echo
