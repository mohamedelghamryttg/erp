...
<div class="row">
                   ...
                   <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a href="<?php echo base_url()?>customer/customerBranch" class="btn btn-default" type="button">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
  ...
  <div class="col-sm-12">
	...
	<?php
        foreach($activityComment->result() as $row)
          {
            $comments = $this->db->get_where('customer_activity_comment',array('activity'=>$row->id,'lead'=>$branch->id))->result();
      ?>
            ...
            <section class="panel">
                <div class="panel-body">
                    <div class="form">
                        ...
                        <input type="text" id="lead" value="<?=$branch->id?>" hidden="">
                        ...
                        <?php }} ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                      <a href="" onclick="addComment(<?=$row->id?>);return false;" class="btn btn-primary" type="button">Send Comment</a>
