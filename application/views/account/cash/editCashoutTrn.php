        ...
        <form class="cmxform form-horizontal " id="form" method="post" enctype="multipart/form-data"
            ...
            <div class="card-body" style="padding-bottom: 0;">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <select name='cash_id' class='form-control m-b' id="cash_id" required>
                            <option value="<?= $cashout->cash_id ?>" selected=''>-- Select Cash --</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="date_sheet form-control" name="cdate" id="cdate"
                            value="<?= date("Y-m-d", strtotime($cashout->date)) ?>" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" class="form-control" name="amount" id="amount"
                            value="<?= $cashout->amount ?>" required step="any" placeholder="0.00"
                            pattern="^\d*(\.\d{0,2})?$"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" class="form-control" name="rate" id="rate" value="<?= $cashout->rate ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="rem" id="rem" class="form-control" rows="6"><?= $cashout->rem ?></textarea>
            ...
            <table class="datatable-bordered datatable-head-custom datatable-table" id="kt_datatable"
                ...
                <thead class="datatable-head">
                    <tr class="datatable-row" style="left: 0px;">
                        ...
                        <th data-field="expenses" class="datatable-cell datatable-cell-sort"><span
