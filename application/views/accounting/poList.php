	...
	<div class="col-sm-12">
		<section class="panel">
			...
			<div class="panel-body">
				<form class="cmxform form-horizontal " action="<?php echo base_url() ?>accounting/poList" id="poList" method="get" enctype="multipart/form-data">
 ...
 -->
					...
					<div class="form-group">
						<div class="col-lg-offset-3 col-lg-6">
							...
							<a href="<?= base_url() ?>accounting/poList" class="btn btn-warning">(x) Clear Filter</a>
					...
					<form class="cmxform form-horizontal " onsubmit="return checkPoVerifyForm()" action="<?php echo base_url() ?>accounting/verifyMultiPos" method="post" enctype="multipart/form-data">
						...
						<table class="table table-striped table-hover table-bordered" style="overflow:scroll;">
							...
							<tbody>
								...
								?>
									<tr>
										<td rowspan="2"><input type="checkbox" class="checkPo" name="select[]" value="<?= $row->id ?>"></td>
										<td><?php echo $this->customer_model->getCustomer($row->customer); ?></td>
										<td><?php echo $row->number; ?></td>
										<td><?= $this->projects_model->getProjectData($job[0]->project_id)->name ?></td>
									...
									<tr>
														...
														<tr>
															...
															<td>
																<?php if ($job->type == 1) { ?>
																	...
																	if ($priceList->rate != 0) {
																	?>
																		<?php echo $jobTotal / $priceList->rate; ?>
																<?php } else {
																		echo 0;
																	}
																} ?>
															</td>
															<td><?php echo $priceList->rate ?? 0; ?></td>
										...
										<td colspan="3">
											<a href="#myModal<?php echo $row->id ?>" style="width: 100%;" data-toggle="modal" class="btn btn-danger">Has Error</a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
