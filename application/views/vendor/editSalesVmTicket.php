      ...
      <?php  } ?>
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>vendor/doEditSalesVmTicket" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class=" form-control" value="<?=$row->ticket_subject?>" name="ticket_subject" required>
                                </div>
                            </div>
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a href="<?php echo base_url()?>vendor/salesVmTicket" class="btn btn-default" type="button">Cancel</a>
                                </div>
                            </div>    
