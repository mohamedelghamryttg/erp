  ...
  <div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
      ...
      <div class="card card-custom gutter-b example example-compact">
        ...
        <form class="form" id="customerfilter" action="<?php echo base_url() ?>projects/allTasks" method="post"
          enctype="multipart/form-data">
          <?php if (isset($_SERVER['HTTP_REFERER'])) { ?>
            <input type="text" name="referer" value="<?= $_SERVER['HTTP_REFERER'] ?>" hidden>
          <?php } else { ?>
            <input type="text" name="referer" value="<?= base_url() ?>projects/allTasks" hidden>
          <?php } ?>
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-3">
                <select name="task_type" class="form-control m-b" id="task_type">
                  ...
                  <?= $this->admin_model->selectAllTaskType($ask_type) ?>
                </select>
              </div>
            ...
            <div class="form-group row">
              ...
              <label class="col-lg-2 col-form-label text-lg-right" for="role name">Date
                To</label>
              <div class="col-lg-3">
            ...
            <div class="card-footer">
              <div class="row">
                ...
                <div class="col-lg-10">
                  ...
                  <a href="<?= base_url() ?>projects/allTasks" class="btn btn-warning"><i class="la la-trash"></i>Clear
                    Filter</a> -->
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="cmxform form-horizontal " action="<?php echo base_url() ?>Projects/confirmTasks"
          onsubmit="return checkTaskConfirmForm();" method="post" enctype="multipart/form-data">
          <?php if ((isset($_REQUEST['status']) && $_REQUEST['status'] == 5)) { ?>
            <div class="col-lg-12">
              <input type="submit" style="margin-right: 5rem;" name="save" value="Confirm Selected Tasks"
              ...
              foreach ($task->result() as $row) {
                ...
                <tr>
                  <td>
                    ...
                    <td>
                      <?php if ($row->status == 5) { ?>
                        <input type="checkbox" class="checkConfirmation" data_code="<?= $row->code ?>" name="select[]"
                          value="<?= $row->id ?>">
                      <?php } ?>
                    </td>
                  <?php } ?>
