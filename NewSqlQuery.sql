...
ALTER TABLE `project` ADD `min_profit_percentage` DOUBLE NULL,ADD `approval_by` INT(11) NULL AFTER `min_profit_percentage`, ADD `approval_at` DATTETIME NULL AFTER `approval_by`; 
