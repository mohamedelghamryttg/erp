...
<!--begin::Card-->
         ...
         <?php if($job->status == 0 && $job->le == $this->user){ ?>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                   <!--begin::Form-->
            <form class="form" action="<?php echo base_url()?>le/jobAction" method="post" enctype="multipart/form-data">
       ...
       <!--begin::Card-->
                <div class="card">
                  ...
                  <div class="card-body">
                       <!--begin::Form-->
            <form class="form"  action="<?php echo base_url()?>le/reopenJob" method="post" enctype="multipart/form-data">
                        <input name="id" type="hidden" value="<?=base64_encode($job->id)?>" readonly="">
                 <div class="card-body">
                      <div class="form-group row">
     ...
     <?php if($job->status == 1 && $job->le == $this->user){ ?>
        <!--begin::Card-->
                <div class="card">
                  ...
                  <div class="card-body">
                    <!--begin::Form-->
                  <form class="form" action="<?php echo base_url()?>le/closeLEJob" method="post" enctype="multipart/form-data">
                     <input name="id" type="hidden" value="<?=base64_encode($job->id)?>" readonly="">
                     <div class="card-body">
                                  <div class="form-group row">
                                        <label class="col-lg-3 col-form-label text-right" for="Division">Action:</label>
     ...
     <!--begin::Card-->
                <div class="card">
                 ...
                 <?php  if($job->status != 2 && $job->status != 4){ ?>
                     ...
                     <!--begin::Form-->
                  <form class="form" id="commentForm" action="<?php echo base_url()?>le/jobRespone" method="post" enctype="multipart/form-data">
                         <input name="id" type="hidden" value="<?=base64_encode($job->id)?>" readonly="">
                     <div class="card-body">
                                 <div class="form-group row">
                                        <label class="col-lg-3 col-form-label text-right" for="comment">Comment:</label>
