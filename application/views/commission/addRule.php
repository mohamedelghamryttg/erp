                ...
                <div class="card-body">                   
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right">Date From <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input name="date_from" type="text" class="form-control date_sheet"  readonly="readonly" placeholder="Select date" />
                        </div>

                        <label class="col-lg-2 col-form-label text-right">Date To <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input name="date_to" type="text" class="form-control date_sheet"  readonly="readonly" placeholder="Select date" />
