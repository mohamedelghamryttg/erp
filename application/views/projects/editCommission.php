    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>projects/doEditCommission" method="post" enctype="multipart/form-data">
                            <input type="text" name="job_id" value="<?=base64_encode($row->job_id)?>" hidden="">
                    		...
                    		<div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <select name="commission" id="commission" class="form-control m-b" onchange="getCommissionEmail();getCommissionRate();" required />
                                            ...
                                            <?=$this->projects_model->selectCommission($row->commission,$brand)?>
                                    </select>
                                </div>
                            </div>
                			...
                			<div class="form-group">
                               ...
                               <?=$this->projects_model->getCommissionEmail($row->commission)?>
                               </div>
                             </div>
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-lg-6">
                                 <input type="number" onkeypress="return rateCode(event)" onblur="calculateMin()" class=" form-control" name="rate" data-maxlength="300" value="<?=$row->rate?>" id="rate" step="any" required>
                               </div>
                             </div>
