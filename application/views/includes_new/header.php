...
<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed aside-enabled aside-static page-loading" style='font-family: "Inter", "Source Sans Pro", Helvetica, Arial, sans-serif;'>
	<!--begin::Main-->
