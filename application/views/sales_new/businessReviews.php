  ...
  <div class="d-flex flex-column-fluid">
    ...
    <div class="container">
      ...
      <div class="card card-custom gutter-b example example-compact">
        ...
        ?>
        <form class="form" id="businessReviewsForm" action="<?php echo base_url() ?>sales/businessReviews" method="get" enctype="multipart/form-data">
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-3">
                ...
                <option value="">-- Select Region --</option> <?= $this->admin_model->selectRegion($region) ?>
                </select>
              </div>
            </div>
            ...
            <div class="card-footer">
              <div class="row">
                ...
                <div class="col-lg-10">
                  <button class="btn btn-success mr-2" name="search" onclick="var e2 = document.getElementById('businessReviewsForm'); e2.action='<?= base_url() ?>sales/businessReviews'; e2.submit();" type="submit">Search</button>
                  <button class="btn btn-secondary" onclick="var e2 = document.getElementById('businessReviewsForm'); e2.action='<?= base_url() ?>sales/exportBusinessReviews'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button>
                  <a href="<?= base_url() ?>sales/businessReviews" class="btn btn-warning"><i class="la la-trash"></i>Clear Filter</a>
          ...
          <tbody>
            ...
            ?>
              <tr class="">
                ...
                <td><?php if (strlen($row->sla_attachment ?? '') > 0) {
                ...
                <td><?php if ($row->sip_status_resolution == 1) {
                      echo "Opened";
