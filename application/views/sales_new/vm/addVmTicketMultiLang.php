    ...
    <div class="container">
        ...
        <div class="card card-custom example example-compact">
            <div class="card-header">
                <h3 class="card-title">  Add VM Ticket </h3>

            </div>
            <!--begin::Form-->
            <form class="form"  action="<?php echo base_url() ?>vendor/doAddVmTicketMultiLang" onsubmit="return checkResouceNumberMultiLang()" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                             <input type="text" class=" form-control" value="<?=  $this->db->query("SELECT project_name FROM `sales_opportunity` WHERE `id` = '$id' ")->row()->project_name;  ?>" name="ticket_subject" disabled="disabled">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <a class="btn btn-secondary"  href="<?= base_url() ?>vendor/vmTicket?t=<?=$from_id?>" class="btn btn-default" type="button">Cancel</a>
                        </div>
                    </div>
                </div>
            </form>
