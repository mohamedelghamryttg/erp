  ...
  <div class="col-sm-12">
    <section class="panel">
      ...
      <header class="panel-heading">
       ...
       <form class="cmxform form-horizontal " action="<?php echo base_url()?>projects/pmoCustomerPm" method="post" id="pmoCustomerPm" enctype="multipart/form-data">
          ...
          <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-3 col-lg-6">
                      ...
                      <button class="btn btn-success" onclick="var e2 = document.getElementById('pmoCustomerPm'); e2.action='<?=base_url()?>projects/exportPmoCustomerPm'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button> 
                       <a href="<?=base_url()?>projects/pmoCustomerPm" class="btn btn-warning">(x) Clear Filter</a>
