						...
						<?php
							if(isset($_GET['search'])){
				                ...
				                if(isset($_REQUEST['date_from']) && isset($_REQUEST['date_to'])){
				                	...
				                	$pms = $this->db->query(" SELECT * FROM users WHERE (role = '2' OR role = '13' OR role = '16' OR role = '29' OR role = '43' OR role = '42' OR role = '45' OR role = '47') AND brand = '$this->brand' ")->result();
                                	foreach($pms as $pm){
