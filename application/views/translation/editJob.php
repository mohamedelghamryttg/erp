    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " action="<?php echo base_url()?>translation/doEditJob" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <select name="translator" class="form-control m-b" id="translator" required />
                                            ...
                                            <?=$this->admin_model->selectAllTranslator($this->brand,$job->translator)?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <select name="task_type" class="form-control m-b" id="task_type" required />
                                            <option disabled="disabled" selected=""></option>
                                            <?=$this->admin_model->selectTaskType($job->task_type,1)?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class=" form-control" onkeypress="return numbersOnly(event)" name="count" value="<?=$job->count?>" id="count" required>
                                </div>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3" style="margin-top: 8px;font-weight: bold;">
                                  <?php if(strlen($job->file) > 0){ ?>
                                    <a target="_blank" href="<?=base_url()?>assets/uploads/translationJob/<?=$job->file?>">Download File</a>
                                  <?php } ?>
                                </div>
                            </div>
