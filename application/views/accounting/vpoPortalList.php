  ...
  <div class="col-sm-12">
    <section class="panel">
      ...
      <div class="panel-body">
        <form class="cmxform form-horizontal " id="vpoForm" action="<?php echo base_url() ?>accounting/vpoVendorPortalList" method="get" enctype="multipart/form-data">
          <?php
          ...
          <div class="form-group">
            <div class="col-lg-offset-3 col-lg-6">
              ...
              <button class="btn btn-success" onclick="var e2 = document.getElementById('vpoForm'); e2.action='<?= base_url() ?>accounting/exportVpoPortal'; e2.submit();" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button>
              <a href="<?= base_url() ?>accounting/vpoVendorPortalList" class="btn btn-warning">(x) Clear Filter</a>
...
<div class="row">
  <div class="col-sm-12">
    <section class="panel">
      ...
      <header class="panel-heading">
        Invoices From Vendor Portal List
      </header>
      ...
      <div class="panel-body">
        <form method="post" action="<?php echo base_url() ?>accounting/confirmInvoiceVendorPortal" onsubmit="return checkPoVerifyForm()" enctype="multipart/form-data">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $this->vendor_model->getVendorEmail($row->vendor); ?></td>
                    ...
                    <td><?php if (strlen($row->vpo_file) > 1) { ?><a href="<?= $this->projects_model->getNexusLinkByBrand() ?>/assets/uploads/invoiceVendorFiles/<?= $row->vpo_file ?>" target="_blank">Click Here</a><?php } ?></td>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form method="post" action="<?php echo base_url() ?>accounting/HasErrorPortalVPO">
