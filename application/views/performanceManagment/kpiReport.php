                ...
                <div class="flex-row-fluid ml-lg-12">                            
                    <div class="card card-custom gutter-b example example-compact">                                    
                        ...
                        <div class="card-body" id="filter11" style="">
                            ...
                            <form class="form" id="reportFilter" action="<?php echo base_url() ?>performanceManagment/kpiReports" method="get" enctype="multipart/form-data" onsubmit="return FormInputs();">
                                ...
                                <div class="form-group row">                           
                                    ...
                                    <div class="col-lg-4">
                                        <select name="department" class="form-control m-b" id="department" onchange="getEmployeesByDepartment()"/>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <button class="btn btn-secondary" name="export" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Export To Excel</button>
                                            <a href="<?= base_url() ?>performanceManagment/kpiReports" class="btn btn-danger"><i class="la la-trash"></i>Clear Filter</a> 
                    ...
                    <div class="card">
                        <div class="card-header flex-wrap border-0 pt-6 pb-0">           
                            <div class="card-title">
                                <h3 class="card-label">Kpi Score Report | <span class="text-dark-50 font-weight-bold" style="font-size: 14px !important;"><?= $total_rows ?? 0 ?> Total</span></h3>
                            </div>
                            ...
                            <table class="table table-separate table-head-custom table-checkable table-hover" id="kt_datatable2">
                                ...
                                <tbody>
                                    <?php foreach ($employees as $emp) { ?>
                                        <tr>
                                            <td ><?= $emp ?></td>
                                            <td class="sticky-col"><?= $this->hr_model->getEmployee($emp); ?></td>
                                            <td class="text-center text-danger" style="font-weight: bold;"><?=$score_avg[$emp].' %'?></td>
                                           <td class="text-center"><?= $counter[$emp]?></td>
                                               <?php foreach ($months_list as $k => $val) { ?>                                       
                                                <td class="text-center status"><?= $scores[$emp][$val][$years_list[$k]]?></td>
                                            <?php } ?>
