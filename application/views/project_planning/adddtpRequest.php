    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                Add New Request "Heads Up"
            </header>
            <div class="panel-body">
                <div class="card card-custom example example-compact">			
                    <!--begin::Form-->
                    <form class="form"action="<?php echo base_url() ?>projectPlanning/doAddDTPRequest" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 control-label text-right" for="role Unit">Work Hours  </label>
                                <div class="col-lg-6">                               
                                    <input type="number" name="work_hours" class="form-control" required min="0" step="0.5"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 control-label text-right" for="role Unit">Overtime Hours  </label>
                                <div class="col-lg-6">                               
                                    <input type="number" name="overtime_hours" class="form-control" required min="0" step="0.5"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 control-label text-right" for="role Unit">Double  Paid Hours  </label>
                                <div class="col-lg-6">                               
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <a href="<?php echo base_url() ?>projectPlanning/jobTasks?t=<?= base64_encode($job) ?>" class="btn btn-default" type="button">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
