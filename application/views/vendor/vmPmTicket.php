				...
				<div class="adv-table editable-table " style="overflow:scroll;">
					<div class="clearfix">
						...
						<?php if($permission->add == 1){ ?>
							<a href="<?=base_url()?>vendor/addVmPmTicket?t=<?=base64_encode($id)?>" class="btn btn-primary ">Add New Ticket</a>
							</br></br></br>
						<?php } ?>
						</div>
...
<!--										<td><?php echo $row->due_date ;?></td>-->
										...
										<td>
											...
											<a href="<?php echo base_url()?>vendor/editVmPmTicket?t=<?php echo 
											base64_encode($row->id) ;?>&from=<?=base64_encode($id)?>" class="">
										...
										<td>
											...
											<a href="<?php echo base_url()?>vendor/deleteVmPmTicket?t=<?php echo 
											base64_encode($row->id) ;?>&from=<?=base64_encode($id)?>" title="delete" 
						...
						?>		
                        <?php
							foreach($sales_ticket->result() as $row)
								{
						?>
									<tr class="">
                                      	<td><?php echo $row->id ;?></td>
